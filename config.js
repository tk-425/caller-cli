...
export const COMMANDS_LIST_PROMPT_NAME = 'cmd';
...
export const GIT_LIST_BRANCH_PROMPT_NAME = 'branch';
export const GIT_LIST_BRANCH_PROMPT_MESSAGE = 'Select a branch';
export const GIT_COMMIT_PROMPT_NAME = 'commitMessage';
...
export const GIT_CREATE_BRANCH_PROMPT_NAME = 'createBranch';
