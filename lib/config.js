...
export const GIT_MAIN_LIST_MESSAGE = 'Select a git command';
...
export const GIT_LIST_PROMPT_MESSAGE = 'Select a git branch:';
...
export const GIT_LIST_OPTION_SELECT_BRANCH_TO_PUSH = 'Select a branch to push';
export const GIT_COMMANDS = [
  ...
  GIT_LIST_OPTION_SELECT_BRANCH_TO_PUSH,
];
...
// BUILD
export const BUILD_TITLE = '- Build Custom Commands -';
...
export const UPDATE_RESET_SUCCESS_MESSAGE =
  'Branch has been successfully reset to match the remote `main`.\n';
export const UPDATE_RESET_FAILED_MESSAGE = 'Error resetting branch';
...
export const UPDATE_NPM_INSTALL_ARGS = [
  '-c',
  'cd /usr/local/share/caller-cli && npm install --production && cd -',
];
