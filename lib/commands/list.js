...
export async function addCommand(name, cmd) {
  try {
    ...
    checkCommandNameFromList(getCommandName(name), name);
...
export async function renameCommand(oldName, newName) {
  try {
    ...
    checkCommandNameFromList(getCommandName(oldName), oldName);
    checkCommandNameFromList(getCommandName(newName), newName);
